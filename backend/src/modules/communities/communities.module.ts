 ...
 * them: membership stints, invitation links, and the OPEN/LOCKED lifecycle.
 * Delegated capabilities and ownership transfer arrive in P3.
 *
 ...
 * It exports its three contracts only:
 *
...
@Module({
  ...
  controllers: [CommunitiesController, CommunityInvitationsController],
  providers: [
  ...
  exports: [COMMUNITY_AUTHORIZATION, COMMUNITY_MEMBERSHIP, COMMUNITY_DIRECTORY],
})
